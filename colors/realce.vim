...
if $TERM =~ '256' || &t_Co >= 256 || has('gui_running')
  ...
  highlight TextYellowU    cterm=underline  ctermfg=221  ctermbg=NONE  gui=underline  guifg=#ffd75f  guibg=NONE     guisp=NONE
  ...
  highlight SpellBad          cterm=underline  ctermfg=252   ctermbg=236   gui=underline  guifg=#d0d0d0  guibg=#242424  guisp=NONE
