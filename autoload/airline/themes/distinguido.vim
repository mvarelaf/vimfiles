" Adapted from https://github.com/vim-airline/vim-airline-themes/blob/master/autoload/airline/themes/distinguished.vim
...
"     \ 'airline_b': s:IA,
"     \ 'airline_c': s:IA}
let g:airline#themes#distinguido#palette.inactive = {
    \ 'airline_a': s:IA,
    \ 'airline_b': s:IA,
    \ 'airline_c': s:IA,
    \ 'airline_x': s:IA,
...
let g:airline#themes#distinguido#palette.normal = airline#themes#generate_color_map(s:N1, s:middle, s:N3)
...
let g:airline#themes#distinguido#palette.normal_modified = {
    \ 'airline_c': [s:orange[1], '', s:orange[0], '', '']}

let g:airline#themes#distinguido#palette.insert = airline#themes#generate_color_map(s:I1, s:middle, s:I3)
let g:airline#themes#distinguido#palette.insert_modified = {}

let g:airline#themes#distinguido#palette.replace = airline#themes#generate_color_map(s:R1, s:middle, s:R3)
let g:airline#themes#distinguido#palette.replace_modified = {}

let g:airline#themes#distinguido#palette.visual = airline#themes#generate_color_map(s:V1, s:middle, s:V3)
let g:airline#themes#distinguido#palette.visual_modified = {}
